...
async function loadProduct() {
    ...
    */
    ...
    <h2 class="text-2xl font-bold text-gray-800">${product.data[0].parcel_name}</h2>
    <p class="text-gray-600">${product.data[0].description}</p>

    <div class="grid grid-cols-2 gap-4 text-gray-700">
        <div>
        <h3 class="font-semibold">Vendor</h3>
        <p>${product.data[0].owner}</p>
      </div>
      <div>
      ...
      <div>
        ...
        <p>${product.data[0].price_m2}</p>
      </div>
      <div>
        <h3 class="font-semibold">Currency</h3>
        <p>${product.data[0].currency}</p>
      </div>
      <div class="col-span-2">
        <h3 class="font-semibold">Location</h3>
        <p>${product.data[0].location_name}</p>
      </div>
    </div>
    ...
    <button
      onclick="buyNow('${product.data[0].uuid}', '${product.data[0].owner_uuid}', '${sender_id} | ${product.data[0].parcel_name} | ${product.data[0].owner_uuid}')"
