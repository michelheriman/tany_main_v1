...
function createParcelCard(parcel) {
    ...
    card.innerHTML = `
        <div class="mb-3">
            <h3 class="text-lg font-semibold text-gray-800">${parcel.properties.parcel_name}</h3>
        </div>
        <div class="space-y-2 text-sm text-gray-600 mb-3">
            <p><span class="font-medium">Location:</span> ${parcel.properties.location_name}</p>
            <p><span class="font-medium">Price per m²:</span> ${formattedPriceM2}</p>
            <p><span class="font-medium">Reference:</span> ${parcel.properties.uuid}</p>
            <p class="text-gray-700">${parcel.properties.description}</p>
        ...
        const graphic = new window.Graphic({
            ...
            popupTemplate: {
                ...
                content: (feature) => {
                    ...
                    div.innerHTML = `
                        <div class="space-y-2 text-sm text-gray-600 mb-3">
                            <p><span class="font-medium">Location:</span> ${feature.graphic.attributes.location_name}</p>
                            <p><span class="font-medium">Price per m²:</span> ${feature.graphic.attributes.formattedPriceM2}</p>
                            <p><span class="font-medium">Reference:</span> ${parcel.properties.uuid}</p>
                            <p class="text-gray-700">${feature.graphic.attributes.description}</p>
                        </div>
                        <div class="mb-4">
